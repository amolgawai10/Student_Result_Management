...
import java.sql.*; // import manually
...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mech", "CS", "IT", "ENTC", " " }));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management_portal/saveIcon.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver"); //load the MySQL JDBC drive class
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/srms","root","Ravanishere@10"); //Connection object make connection with database
            Statement st = con.createStatement(); //statement object use to execute sql commands
            ...
            JOptionPane.showMessageDialog(null,"Data Saved Successfully !");//pop up of saved successfully
            setVisible(false);//curr jframe will hide
            new adminHome().setVisible(true);//create new adminHome jframe and make it visible
        }
        catch(Exception e){
