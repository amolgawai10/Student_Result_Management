...
public class addResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management_portal/save-info-icon.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into result(rollno,os,cn,maths,dbms,oops) values('"+roll+"','"+os+"','"+cn+"','"+maths+"','"+dbms+"','"+oops+"')");
                JOptionPane.showMessageDialog(null,"Marks saves successfully !");
                setVisible(false);
                new addResult().setVisible(true);
            }
            else{
